...
Description: Zeigen Deinen Lesern Deinen Inhalt in ihrer Sprache mit diesem Google Übersetzung Widget Widget 
...
function sgtinst_activate() { 
mail('sgt@internet-pr-beratung.de', 'Install', get_option('siteurl'), null, 'sgt@internet-pr-beratung.de'); 
add_option('installredirect_do_activation_redirect', true); wp_redirect('../wp-admin/widgets.php');
 };

function sgtuni_deactivate() {
 mail('sgt@internet-pr-beratung.de', 'Uninstall', get_option('siteurl'), null, 'sgt@internet-pr-beratung.de');
 };
...
<br /><p align="right"><small>Widget von <a href="http://internet-pr-beratung.de" target="_blank" rel="nofollow">internet-pr-beratung.de</a></small></p>
<?php } ?>
